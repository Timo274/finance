...
import db, { rowToPlan, currencyRate, setCurrencyRate, eurRate, setEurRate } from "../db.js";
...
import { textValue, positiveNumber, isoDateValue, todayISO } from "../sanitize.js";
...
export default function registerPlanRoutes(app) {
  ...
  app.post("/api/plan/close", requireAuth, (req, res) => {
    ...
    const purchasesRaw = Array.isArray(req.body?.purchases) ? req.body.purchases : null;
