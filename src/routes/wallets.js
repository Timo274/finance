...
import { getActivePlan, getActiveItems, getWallets, getManualPlan } from "../store.js";
import { allocate, amountToFund } from "../allocation.js";
import { sanitizeEntries, sanitizeManualPlan, monthForPlan } from "../sanitize.js";
...
export default function registerWalletRoutes(app) {
  ...
  app.post("/api/manual-plan", requireAuth, (req, res) => {
    ...
    if (invalid) return res.status(400).json({ error: "item_not_found", itemId: invalid.itemId });
